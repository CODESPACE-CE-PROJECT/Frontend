  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <div className=" mx-44 my-20">
          ...
          <h2 className="text-xl font-bold text-center text-black">สร้างแบบฝึกหัด/การทดสอบ</h2>
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="flex flex-col">
                ...
                <input
                  type="datetime-local"
                  className="w-full p-2 border border-gray-300 rounded-md text-black"
                  onChange={(e) => handleInputChange(e.target.value, "announceDate")}
                />
              </div>
            </div>
          ...
          <div className="mt-6 flex justify-center gap-4">
            ...
            <button
              ...
              onClick={onSubmit} // Call onSubmit to handle the form submission
            >
              สร้าง
            </button>
          </div>
