        ...
        <div className="shadow-md rounded-lg px-8 py-6 max-w-md w-full">
          ...
          <form action="#">
            ...
            <button
              ...
              className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#0053A6] hover:bg-[#EEF3ED] "
            >
              Log in
            </button>
