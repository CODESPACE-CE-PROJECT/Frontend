...
import { updateSchoolById } from "@/app/services/school.service";
...
export default function SchoolEdit() {
  ...
  const handleSubmit = async () => {
    ...
    Swal.fire({
      ...
      willOpen: async () => {
        Swal.showLoading()
        await updateSchoolById(updateForm, param.schoolId)
        Swal.hideLoading()
        Swal.fire({
          icon: 'success',
            ...
            <div className="flex flex-col items-start gap-[10px] self-stretch">
              <div className="flex flex-col justify-end items-end gap-[51px] self-stretch">
                <div className="flex flex-col items-start gap-[32px] self-stretch">
                  <UploadFile onInput={handleFileInput} imageUrl={imageUrl} />
